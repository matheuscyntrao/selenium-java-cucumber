@sanity @login @colaborador @ready @88884
Feature: [Sanity] Login como colaborador

  Scenario Outline: Realizar login como colaborador com sucesso
    ...
    Examples:
      | usuario      | senha     |
      | COLABORADOR  | 123123123 |

  Scenario Outline: Realizar login como colaborador sem permissao
    ...
    Examples:
      ...
      | SEMPERMISSAOCOMARROBA@gmail.com | 123123123 |
      | abc                             | 123123123 |
      | 1                               | 123123123 |

  Scenario Outline: Realizar login como colaborador com permissão utilizando @
    ...
    Examples:
      | usuario                     | senha     |
      | COLABORADOR@ache.com.br     | 123123123 |
